...
actualPos.push(0);
//-----------------------------------------------------------------------------INITIATE
//Loader.LoadMeFBXAnimate(scene,'./models/Walking.fbx',1,new Vector3(90,180,0),new Vector3(0,0,2),mixer,me);
...
function animate() {
	requestAnimationFrame( animate );
        ...
        pivot.rotateOnWorldAxis(new THREE.Vector3(1,0,0),spin*listKey[0]-spin*listKey[2]);
        pivot.rotateOnWorldAxis(new THREE.Vector3(0,1,0),spin*listKey[1]-spin*listKey[3]);
